                ...
                >
                    ...
                    >
                        ...
                        <Typography variant="body1" className={classes.byLine}>
                            You can check out some of <a href="https://github.com/AmanJaiswal0612" className={classes.textColored} target="_blank" rel="noreferrer">my work</a> or <span style={{textDecoration:"underline"}} onClick={()=>SmoothScroll("#contact")} className={classes.textColored}>get in touch</span> with me.
                        </Typography>
                    </Grid>
                </Grid>
            </Container>
