...
const ContactLinks = () => {
    ...
    return (
        <>
            ...
            <a href="https://medium.com/@aman.jaiswal0612" target='_blank'>
            ...
            <Button variant="contained" href={"https://drive.google.com/file/d/1GDqiMvoE-HmMXToYGIxhbuoDlGqwRRqu/view"} target="_blank" className={classes.themeBtn} download>View Resume</Button>
        </>
    );
};
